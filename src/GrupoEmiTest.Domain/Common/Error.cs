...
namespace GrupoEmiTest.Domain.Common
{
    ...
    public record Error
    {
        ...
        /// <summary>
        /// Creates a new <see cref="Error"/> of type <see cref="ErrorType.Unauthorized"/>.
        /// </summary>
        /// <param name="code">A unique code identifying the error.</param>
        /// <param name="description">A human-readable description of the error.</param>
        /// <returns>A new <see cref="Error"/> instance with <see cref="ErrorType.Unauthorized"/>.</returns>
